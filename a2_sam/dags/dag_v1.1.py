...
with DAG(
    ...
    #     bash_command=(
    #         'cd /opt/airflow/scripts && '
    #         'python3 bronze_features_clickstream.py '
    #         '--snapshotdate "{{ ds }}"'
    #     ),
    # )
    ...
    bronze_table_2 = BashOperator(
        ...
        bash_command=(
            'cd /opt/airflow/scripts && '
            'python3 bronze_features_attributes.py '
            '--snapshotdate "{{ ds }}"'
        ),
    )
    ...
    bronze_table_3 = BashOperator(
        ...
        bash_command=(
            'cd /opt/airflow/scripts && '
            'python3 bronze_features_financials.py '
            '--snapshotdate "{{ ds }}"'
        ),
    )
    ...
    silver_table_1 = BashOperator(
        ...
        bash_command=(
            'cd /opt/airflow/scripts && '
            'python3 silver_features_combined_1.py '
            '--snapshotdate "{{ ds }}"'
        ),
    )
    ...
    silver_table_2 = BashOperator(
        ...
        bash_command=(
            'cd /opt/airflow/scripts && '
            'python3 silver_features_financials.py '
            '--snapshotdate "{{ ds }}"'
        ),
    )
    ...
    model_1_monitor = BashOperator(
        ...
        bash_command=(
            ...
            '--snapshotdate "{{ ds }}" '
            '--model_bank_dir "scripts/model_bank/" '
            '--output_dir "datamart/monitoring/"'
        ),
    )
